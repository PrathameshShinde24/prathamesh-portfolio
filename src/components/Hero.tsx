...
const Hero = () => {
  ...
  return (
    <section className="pt-32 pb-20 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-blue-900 min-h-screen flex items-center">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="flex justify-center lg:justify-end relative">
              <div className="relative">
                ...
                <div className="absolute -bottom-6 -left-6 w-4 h-4 bg-green-400 rounded-full"></div>
                ...
                <div className="relative">
                  <img
                    ...
                    className="w-80 h-80 rounded-full object-cover border-4 border-white dark:border-gray-700 shadow-2xl"
                  />
