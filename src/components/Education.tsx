...
const Education = () => {
  ...
  return (
    <section className="min-h-screen flex items-center py-16 sm:py-20 lg:py-24 bg-gradient-to-br from-green-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-green-900 dark:to-blue-900 transition-colors duration-300">
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-10">
          ...
          <Card className="bg-white dark:bg-gray-800 shadow-xl hover:shadow-2xl transition-all duration-300">
            <CardHeader>
              <CardTitle className="text-2xl sm:text-3xl text-gray-800 dark:text-white flex items-center gap-3">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-gray-700 dark:to-gray-600 rounded-xl p-4">
                  <p className="text-gray-700 dark:text-gray-200">
                    Currently pursuing a comprehensive degree in Computer Science with a focus on 
            ...
            <CardContent>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {certifications.map((certification, index) => (
                  <div
                    key={index}
                    className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-gray-700 dark:to-gray-600 rounded-xl p-4 hover:scale-105 transition-transform duration-300"
                  >
